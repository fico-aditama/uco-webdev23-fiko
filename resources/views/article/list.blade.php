    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-end">
            @if (count($articles) < 10)
                ...
                <button type="button" class="btn btn-success" onclick="window.location='{{ route('article.create') }}';">
                ...
                @endcanny
                <button type="button" class="btn btn-secondary" onclick="window.location='{{ route('article_category.list') }}';">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-bag-plus" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                            d="M8 7.5a.5.5 0 0 1 .5.5v1.5H10a.5.5 0 0 1 0 1H8.5V12a.5.5 0 0 1-1 0v-1.5H6a.5.5 0 0 1 0-1h1.5V8a.5.5 0 0 1 .5-.5" />
                                    ...
                                    <div class="solution_cards_box">
                                        <div class="solution_card">
                                            ...
                                            <div class="solu_title">
                                                ...
                                                <div class="mt-3">
                                                    <a
                                                        href="{{ route('article.single', ['slug' => $article->slug]) }}#comment">Lihat
