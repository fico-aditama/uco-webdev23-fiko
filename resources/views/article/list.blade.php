    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-end">
            @if (count($articles) < 100)
                <button type="button" class="btn btn-primary" onclick="window.location='{{ route('article.create') }}';">
                                ...
                                <div class="our_solution_category">
                                    <div class="solution_cards_box">
                                        <div class="solution_card">
                                            ...
                                            <div class=so_top_icon><svg enable-background="new 0 0 512 512"height=50
                                                    id=Layer_1 viewBox="0 0 512 512"width=40
                                            ...
                                            {{-- <div class="solu_title"><h3>{{ $article['title'] }}</h3></div> --}}
